...
void AlgeeIntake::IntakeAlgeeEnd() { m_algeeIntakeMotorController.StopMotor(); }
...
void AlgeeIntake::WinchRetractEnd() { m_winchMotorController.StopMotor(); }
...
void AlgeeIntake::WinchExtendEnd() { m_winchMotorController.StopMotor(); }